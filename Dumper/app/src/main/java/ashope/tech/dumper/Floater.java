...
public class Floater extends Service {
    ...
    public void Menu() {
        ...
        AddText(2, "1- Added SDK Name for better output showcase", 15, 1, "#FF13FF00");
        AddText(2, "2- Fixed Many minor and major bugs", 15, 1, "#FF13FF00");
        AddText(2, "3- Added Actors Dump", 15, 1, "#FF13FF00");
        AddText(2, "4- Added Old GName Reading option for PUBG Mobile series (Lite needs Dec)", 15, 1, "#FF13FF00");
        AddText(2, "5- Added auto offset selector", 15, 1, "#FF13FF00");
        AddText(2, "5- Added auto UE version selector", 15, 1, "#FF13FF00");
